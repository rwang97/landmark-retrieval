...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_embeds_path", type=Path, default='/home/ubuntu/google-landmark/landmark-retrieval/baseline_unet/inference_results/16250/embeds/test')
    parser.add_argument("--index_embeds_path", type=Path, default='/home/ubuntu/google-landmark/landmark-retrieval/baseline_unet/inference_results/16250/embeds/index')
    parser.add_argument("--prediction_csv", type=Path, default='/home/ubuntu/google-landmark/landmark-retrieval/baseline_unet/inference_results/16250/prediction.csv')
